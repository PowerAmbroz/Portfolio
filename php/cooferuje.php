...
<head>
  ...
  <link rel="stylesheet" href="../style/cooferuje.css" type="text/css" />
...
<body onload>
  ...
  <div id="container">
    ...
    <div class="square">
      ...
      <a href="cooferuje.php" id="cooferuje" class="tilelink">
        <div class="tile1_1">
          <i class="icon-pencil"></i><br />Rejestracja
        </div></a>
      <!-- <div style="clear:both"></div> -->

      <a href="" id="cv" target="_blank" class="tilelink">
        <div class="tile2">
          <i class="icon-login"></i><br />Logowanie
        </div></a>
      <a href="kontakt.php" id="kontakt" class="tilelink">
        <div class="tile3">
          <i class="icon-table"></i><br />Dynamiczna Tabela
        </div></a>
      <!-- <div style="clear:both"></div> -->
